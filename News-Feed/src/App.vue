  ...
  <div>
    <div id="pages">
      <div id="choose-page-one">
        <router-link class="page-anchor" :to="{ name: 'all' }">ALL NEWS</router-link>
      </div>
      <div id="choose-page-two">
        <router-link class="page-anchor" :to="{ name: 'custom' }">NEWS BY CHANNEL</router-link>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    fetchSources() {
      this.axios.get("https://newsapi.org/v1/sources").then(({ data }) => {
        //console.log(data);
